"""
Django settings for financo_45430 project.
...
ROOT_URLCONF = 'financo_45430.urls'
...
WSGI_APPLICATION = 'financo_45430.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "financo_45430 API",
    "DESCRIPTION": "API documentation for financo_45430 App",
    "VERSION": "v1",
}
